							...
							<div class="card border-0 rounded-4 p-xl-4 p-lg-4 p-md-4 p-3">
								...
								<div class="simple-form">
									<div class="form-header text-center mb-5">
										...
										<h4 class="fs-2"> Connectez-vous à votre Compte </h4>
									</div>
                                            ...
                                            <div class="d-flex align-items-center justify-content-between">
                                                <div class="flex-shrink-0 flex-first">
                                                    <div class="form-check form-check-inline">
                                                        ...
                                                        <label class="form-check-label" for="save-pass">Se Rappeler de Moi?</label>
                                                    </div>	
                                                </div>
                                                <div class="flex-shrink-0 flex-first">
                                                    <a href="#" class="link fw-medium">Mot de Passe Oublié?</a>	
                                                </div>
                                            </div>
                                        </div>
										<div class="form-group">
											<button type="submit" class="btn btn-primary full-width fw-medium"> Se connecter <i class="fa-solid fa-arrow-right-long ms-2"></i></button>
										</div>
                                        <div class="text-center">
                                            <p class="mt-4"> Vous n'avez pas de compte? <a href="{{ route('register') }}" class="link fw-medium"> S'inscrire </a></p>
                                        </div>
									</form>
								</div>
